...
In this test case, specific inputs from a realistic dataset that was found to cause this problem is used and
the trim solution is attempted but it still produces the same behaviour
"""
...
but sounds odd, just like any other word-to-word translation does."
    ...
    # SCENARIO 1
    # IN THIS CASE, THE PROBLEMATIC PAYLOAD IS TRIMMED AT 4000 BYTES WHICH IS LOWER THAN BOTH LIMITS BUT IT STILL
